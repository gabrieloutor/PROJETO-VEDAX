...
!function (e) {
    ...
    n.prototype = {constructor: n, toggle: function (t) {
            ...
            if (!o && t.type != "mouseover" || a && t.type == "mouseover")
                "ontouchstart"in document.documentElement && (e('<div class="dropdown-backdrop"/>').insertBefore(e(this)).on("click", r), n.on("hover", function () {
    ...
    t.prototype = {constructor: t, init: function (t, n, r) {
            ...
            var t = this, n = this.tip(), r = e.Event("hideme");
    ...
    }, e.fn.tooltip.Constructor = t, e.fn.tooltip.defaults = {animation: !0, placement: "top", selector: !1, template: '<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", title: "", delay: 0, html: !0, container: !1}, e.fn.tooltip.noConflict = function () {
