                                ...
                                <header>
                                    ...
                                    <nav class="moduletable navigation ">
                                        <div class="moduletable-wrapper">
                                            ...
                                            <script type="text/javascript">
                                            $('#as-menu').prepend('<div id="menu-button">Menu</div>');
  $('#as-menu #menu-wrapper').on('click', function(){
    var menu = $(this).next('ul');
    if (menu.hasClass('current active')) {
      menu.removeClass('current active');
    } else {
      menu.addClass('current active');
    }
});
</script>
                                            <!-- INICIO MENU -->
                                            <div id="as-menu" class="menu-wrapper">
                                                <ul class="as-menu ">
                                                    <li class='active'>
                                                        <a href="testedb.php">Home</a>

                                                    </li>
                                                    <li>
                                                        <a href="testedb.php">Empresa</a>

                                                    </li>
                                                    <li>
                                                        <a href="testedb.php">Produtos</a>
                                                    </li>
                                                    <li>
                                                        <a href="testedb.php">Serviços</a>

                                                        <ul>
                                                            <li>
                                                                <a href="testedb.php">Tratamento Térmico</a>

                                                            </li>
                                                            <li>
                                                                <a href="testedb.php">Soldagem</a>

                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        <a href="testedb.php">Localização</a>
                                                    </li>
                                                    <li>
                                                        <a href="testedb.php">Fale Conosco</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <!-- FIM MENU -->
